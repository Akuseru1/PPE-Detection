...
def class_dict_from_pbtxt(pbtxt_path):
    ...
    names = [
        l.replace("display_name:", "").replace('"', "").strip()
        for l in data
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "csv_input", metavar="csv_input", type=str, help="Path to the CSV input"
    )
    parser.add_argument(
        "pbtxt_input",
        metavar="pbtxt_input",
    ...
    parser.add_argument(
        "output_path", metavar="output_path", type=str, help="Path to output TFRecord"
    )
